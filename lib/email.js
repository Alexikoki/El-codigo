...
import { verificarFirmaQR, firmarToken } from '../../../lib/qr'
...
export async function POST(request) {
  ...
  // Generar QR personal firmado con el ID del cliente
  const qrPersonal = firmarToken(cliente.id)

  // Guardar qr_personal en cliente
  await supabaseAdmin
    .from('clientes')
    .update({ qr_personal: qrPersonal })
    .eq('id', cliente.id)
