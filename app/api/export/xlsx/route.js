...
export async function GET(request) {
  try {
    ...
    const ws4 = XLSX.utils.json_to_sheet(filaRef.length ? filaRef : [{ Info: 'Sin promotores' }])
    ...
    ws4['!cols'] = [{ wch: 22 }, { wch: 28 }, { wch: 12 }, { wch: 16 }]
    ...
    XLSX.utils.book_append_sheet(wb, ws4, 'Promotores')
