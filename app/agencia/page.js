...
import { LogOut, BarChart3, TrendingUp, Briefcase, PlusCircle, Users, Link as LinkIcon, ShieldAlert } from 'lucide-react'
            ...
            {tab === 'equipo' && (
              <div className="space-y-5">
                ...
                <div className="space-y-3">
                  {equipo.map((r) => (
                    <div key={r.id} className="glass-panel p-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                      <div>
