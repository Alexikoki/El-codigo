      ...
      <main className="max-w-3xl mx-auto px-6 py-14">
        ...
        <div className="space-y-8 text-[#374151] leading-relaxed text-sm">
          ...
          <section>
            ...
            <p>El presente aviso legal regula el acceso y el uso de la plataforma web <strong>El Código</strong> (en adelante, "la Plataforma"), cuya actividad consiste en la gestión digital de sistemas de referidos mediante códigos QR para establecimientos turísticos y de hostelería.</p>
          ...
          <section>
            ...
            <p>Todos los contenidos de la Plataforma — incluyendo, sin limitación, textos, imágenes, logotipos, iconos, código fuente y diseño — son propiedad de El Código S.L. o de sus licenciantes, y están protegidos por las leyes españolas e internacionales de propiedad intelectual e industrial.</p>
          ...
          <section>
            ...
            <p>El Código S.L. se reserva el derecho de modificar en cualquier momento el contenido del presente aviso legal. Los cambios entrarán en vigor desde su publicación en la Plataforma.</p>
          </section>
